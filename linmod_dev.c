...
const char *MODULE_NAME = "linmod_dev";
const char *DEVICE_NAME = "linmod";
...
static int __init linmod_dev_init(void)
{
  int len = 0;
  struct timeval time;
...
static void __exit linmod_dev_exit(void)
{
  vfree(msg_buffer);
...
module_init(linmod_dev_init);
module_exit(linmod_dev_exit);
